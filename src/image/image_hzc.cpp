...
{
  // We impose that the std::vector is a valid stream. This means that atleast the first 3 characters should be 'hzc'
  // Also, we impose that the size of the vector stream is enough for the metadata. (this is done in Get function)
  // TODO
  MetaData meta_data; 
